...
class VariantServiceTest < ActiveSupport::TestCase
  ...
  EXPECTED_TRANSFORMATIONS_PER_FILENAME = [
    ...
    ['dan-gold_crop_left@2x.jpeg', { resize_to_limit: [2972, 1672] }],
    ...
    ['dan-gold_1500x500_crop_left.jpeg', { resize_to_limit: [1500, 500] }],
    ['dan-gold_800x840_crop_left.jpeg', { resize_to_limit: [800, 840] }],
    ['dan-gold', { }],
