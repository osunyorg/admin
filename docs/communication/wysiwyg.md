...
-[ ] A la suppression d'une image dans l'éditeur, bien supprimer l'élément parent s'il est :
  - un `<action-text-attachment>` (image déjà sauvegardée)
  - un `[data-trix-attachment]` (image seulement uploadée dans le formulaire en cours)
