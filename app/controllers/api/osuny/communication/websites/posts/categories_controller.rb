class Api::Osuny::Communication::Websites::Posts::CategoriesController < Api::Osuny::Communication::Websites::ApplicationController
  ...
  def upsert
    ...
    permitted_categories_params.each_with_index do |permitted_category_params, index|
      category = website.post_categories.find_by(migration_identifier: permitted_category_params[:migration_identifier])
      if category.present?
        ...
        category = website.post_categories.build(permitted_category_params)
        if category.save
  ...
  def build_category
    @category = website.post_categories.build
  ...
  def ensure_migration_identifier_is_available
    if website.post_categories.with_deleted.where(migration_identifier: @migration_identifier).any?
  ...
  def category_params_for_upsert(category_params)
    ...
    category = website.post_categories.find_by(migration_identifier: permitted_params[:migration_identifier])
