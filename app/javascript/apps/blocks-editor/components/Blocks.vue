        ...
        <div class="col-lg-8 col-xxl-6">
          <article class="card card-body px-3 px-sm-5 border-bottom border-light">
            <div class="text-end mb-2">
              ...
              <a href="#" class="action ms-2" @click="edit($event, block)">{{ i18n.blocksEditor.actions.edit }}</a>
            </div>
            <div class="content-editor__elements__preview
                        content-editor__elements__preview--organizations">
              <div v-html="block.snippet"></div>
            </div>
            <span class="small a11y__status"></span>
          </article>
        </div>
      </div>
    </div>
