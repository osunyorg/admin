module AsLocalization
  ...
  # Used to put the files in the correct directory
  # If an index does not exist in a language, use the default index
  def slug_with_ancestors_slugs_with_draft
    slug_pathes do |ancestor|
