...
#
class University::Organization::Localization::Location < University::Organization::Localization
  def self.polymorphic_name
    'University::Organization::Localization::Location'
  end
  ...
  def template_static
    "admin/university/organizations/locations/static"
  end
