class Communication::Website::Page::Accessibility < Communication::Website::Page
  ...
  def generate_declaration(l10n)
    l10n.generate_block(:title, 'Déclaration d\'accessibilité')
    l10n.generate_block(:files, {
  ...
  def generate_results(l10n)
    l10n.generate_block(:title, 'Résultats des tests')
    l10n.generate_block(:key_figures, {
  ...
  def generate_conformity(l10n)
    l10n.generate_block(:title, 'État de conformité')
    l10n.generate_block(:chapter, {
  ...
  def generate_unaccessible(l10n)
    l10n.generate_block(:title, 'Contenus non accessibles')
    l10n.generate_block(:chapter, {
  ...
  def generate_conditions(l10n)
    l10n.generate_block(:title, 'Établissement de cette déclaration d\'accessibilité')
    l10n.generate_block(:chapter, {
  ...
  def generate_environment(l10n)
    l10n.generate_block(:title, 'Environnement de test')
    l10n.generate_block(:chapter, {
  ...
  def generate_problem(l10n)
    l10n.generate_block(:title, 'Voies de recours')
    l10n.generate_block(:chapter, {
