...
#
class Communication::Website::Configs::DeuxfleursToml < Communication::Website::Configs::Base

  def self.polymorphic_name
    'Communication::Website::Configs::DeuxfleursToml'
  end
  ...
  def template_static
    "admin/communication/websites/configs/deuxfleurs_toml/static"
  end
