Communication::Website::Agenda::Planner::TimeSlots
  ...
  def apply_time!
    # TODO
    @time_slots = @time_slots.public_send(planner.time)
    @time_slots = archive? ? @time_slots.ordered_desc : @time_slots.ordered_asc
  end
